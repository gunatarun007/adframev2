...
def run_world_model_analysis(args):
    ...
    for frame_idx in args.frames:
        ...
        prompt = (
            ...
            "3. Locate and segment at most 2 major surfaces (materials, orientation). "
            "4. Segment at most 3 key visible objects (depth order, and occlusion properties). "
            "5. Detect at most 2 empty placement regions on horizontal surfaces. "
            "6. Calculate and rank at most 2 placement candidates with scores (0.0 to 1.0) and recommended product size. "
